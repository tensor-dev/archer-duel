(function(){
    ...
    Room.prototype._notifyStateChanged = function() {
        console.log("Room " + self._id + " broadcasting >state<");
    ...
    Room.prototype.removeClient = function(socket, data) {
        ...
        // Если игроков не осталось - комната мертвая
        if(players.length == 0) {
            this._state = 'dead';
        ...
        if(player) {
            ...
            socket.on('fire', function(data){
                if(player == self._players[self._currentPlayer]) {
                    console.log("Room " + self._id + " broadcasting >fire<");
    ...
    Room.prototype.toJSON = function() {
        return {
            ...
            spectactors: this._spectactorsCount
        };
    };
